 ...
 */
test('providerMcpService handles claude MCP scopes/transports with file-backed persistence', async () => {
 ...
 * one payload is written to all providers (Claude is the only provider today).
 */
test('providerMcpService global adder writes to all providers and rejects unsupported transports', async () => {
