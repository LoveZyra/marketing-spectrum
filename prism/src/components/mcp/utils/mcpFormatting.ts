...
const assertSupportedTransport = (provider: McpProvider, transport: McpTransport) => {
...
export const parseJsonMcpPayload = (
  ...
  assertSupportedTransport(provider, transport);
...
export const createMcpPayloadFromForm = (
  ...
  assertSupportedTransport(provider, formData.transport);
