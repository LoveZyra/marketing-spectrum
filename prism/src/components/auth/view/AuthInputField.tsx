    ...
    <div>
      ...
      <div className="group relative">
        ...
        <input
          ...
          className={`w-full rounded-lg border border-border bg-background py-2.5 text-foreground transition-colors placeholder:text-muted-foreground hover:border-border-strong focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30 disabled:cursor-not-allowed disabled:opacity-60 ${
            Icon ? 'pl-10' : 'pl-3.5'
