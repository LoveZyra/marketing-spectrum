        ...
        <SettingsCard>
          ...
          >
            <select
              ...
              className="w-full touch-manipulation rounded-md border border-input bg-transparent p-2.5 text-sm text-foreground transition-colors focus:border-primary focus:outline-none focus:ring-1 focus:ring-ring sm:w-36"
            >
        ...
        <SettingsCard divided>
          ...
          >
            <select
              ...
              className="w-full touch-manipulation rounded-md border border-input bg-transparent p-2.5 text-sm text-foreground transition-colors focus:border-primary focus:outline-none focus:ring-1 focus:ring-ring sm:w-28"
            >
