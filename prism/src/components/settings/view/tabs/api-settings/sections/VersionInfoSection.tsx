...
// Attribution and upstream references. The vendor's own site and its hosted
// offering used to be linked from here too, which made this build advertise a
// paid product it is not and cannot sign anyone up for.
