    ...
    <div className="flex h-full w-full flex-col bg-muted">
      ...
      <div className="relative flex-1 overflow-hidden p-2">
        ...
        {cliPromptOptions && isConnected && (
          <div
            className="absolute inset-x-0 bottom-0 z-10 border-t border-border bg-muted px-3 py-2 md:hidden"
            ...
            <div className="flex flex-wrap items-center gap-2">
              {cliPromptOptions.map((opt) => (
                <button
                  ...
                  className="max-w-36 truncate rounded bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary"
              ...
              <button
                ...
                className="rounded bg-muted px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-border"
              >
                Esc
              </button>
            </div>
