...
const KEY_BTN =
  'shrink-0 rounded-md border border-border bg-muted px-2.5 py-1.5 text-xs font-medium text-foreground transition-colors select-none active:bg-primary active:text-foreground active:border-primary/[0.32] disabled:cursor-not-allowed disabled:opacity-40';
const KEY_BTN_ACTIVE =
  'shrink-0 rounded-md border border-primary/[0.32] bg-primary px-2.5 py-1.5 text-xs font-medium text-primary-foreground transition-colors select-none disabled:cursor-not-allowed disabled:opacity-40';
const ICON_BTN =
  'shrink-0 rounded-md border border-border bg-muted p-1.5 text-foreground transition-colors select-none active:bg-primary active:text-foreground active:border-primary/[0.32] disabled:cursor-not-allowed disabled:opacity-40';
...
export default function TerminalShortcutsPanel({
  ...
  return (
    <div className={`pointer-events-none fixed inset-x-0 ${bottomOffset} z-20 px-2 md:hidden`}>
      <div className="prism-modal-shadow pointer-events-auto flex items-center gap-1 overflow-x-auto rounded-lg border border-border bg-muted px-1.5 py-1.5 [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <button
          type="button"
