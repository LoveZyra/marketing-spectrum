...
// This banner sits on the chat empty state, which is on the eager render path,
// so anything it imports statically lands in the entry chunk. The setup modal
// embeds a full terminal (xterm, ~400 kB) to run the TaskMaster installer, and
// neither modal renders until a button is clicked — so both are deferred and
// their JSX is gated on the open flag rather than mounted-and-self-hidden.
// Without the gate the lazy import would resolve on mount and defer nothing.
