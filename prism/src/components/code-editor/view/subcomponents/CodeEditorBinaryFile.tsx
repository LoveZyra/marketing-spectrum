...
export default function CodeEditorBinaryFile({
  ...
  const binaryContent = (
    <div className="flex h-full w-full flex-col items-center justify-center bg-background p-8 text-muted-foreground">
      <div className="flex max-w-md flex-col items-center gap-4 text-center">
        ...
        <button
          onClick={onClose}
          className="mt-4 rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground transition-colors hover:bg-primary-hover"
        >
          Close
        </button>
      </div>
  ...
  const innerClassName = isFullscreen
    ...
    : 'bg-background prism-modal-shadow flex flex-col w-full h-full md:rounded-lg md:prism-modal-shadow md:w-full md:max-w-2xl md:h-auto md:max-h-[60vh]';
