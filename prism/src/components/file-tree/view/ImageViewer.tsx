...
export default function ImageViewer({ file, onClose }: ImageViewerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(16,16,16,0.72)]">
      <div className="prism-modal-shadow mx-4 max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg bg-background">
