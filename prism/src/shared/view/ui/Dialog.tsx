  ...
  ({ className, children, onEscapeKeyDown, onPointerDownOutside, wrapperClassName, ...props }, ref) => {
    ...
    return createPortal(
      <div className={cn('fixed inset-0 z-50', wrapperClassName)}>
        {/* Overlay */}
        <div
          className="fixed inset-0 animate-dialog-overlay-show bg-[rgba(16,16,16,0.72)] backdrop-blur-[2px]"
          onClick={() => {
        ...
        <div
          ...
          className={cn(
            ...
            'rounded-dialog border border-border bg-popover text-popover-foreground prism-modal-shadow',
