 ...
 *
 * Prism can be served from a path prefix by a reverse proxy, for example:
 *   /ai/assets/index-abc123.js
 *   /ai/icons/favicon.png
 *
 ...
 * case is easy to misread because asset URLs such as /icons/favicon.png
    ...
    <I18nextProvider i18n={i18n}>
      <ThemeProvider>
        <AuthProvider>
          <WebSocketProvider>
                <ProtectedRoute>
                  {/* AuthLoadingScreen 已经是这条路径上"还不知道要渲染什么"的
                      占位,拿它当 Suspense fallback 不引入新的视觉状态。 */}
